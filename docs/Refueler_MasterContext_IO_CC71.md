# Refueler Master Context — IO CC-71
*Updated: 2026-07-29 (CC-71)*
*Supersedes: Refueler_MasterContext_IO_CC70.md*
*Sync log: MasterContext_IO_CC71 — Repo hygiene pass. Pre-pivot file purge: ~15,000 deletions across 4 commits. Removed CC-18 onboarding HTML (M01–M06), 01_Prototypes/, 02_B2C_Markets/, pre-pivot root files, Costa UX research. Kept: Lakeside audit, csuite briefing, eta widget, england skin, App.tsx (not found in refueler-app). Remaining folders queued: 06_Benchmarks, 07_App_Specs, C-Suite, Session prompts, UK Banks.*
