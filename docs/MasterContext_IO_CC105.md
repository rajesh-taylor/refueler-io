# Refueler Master Context — IO CC-105
*Updated: 2026-08-22 (CC-105 / Web-Touch-1 — hamburger nav, S-32 owner two-col, S-33 ops sign-out, S-28 privacy padding, S-29 nav portrait, S-34 CHANGE button Carbon contrast)*
*Supersedes: MasterContext_IO_CC104*
...
|---|---|---|---|
| S-22 | Email fallback link block spacing / iOS border | Low | Future email session |
| S-25 | Order tile background hardcoded to Carbon surface token | Low | Future |
| S-35 | Sign-out button on Queue page — move to OPS only | Medium | Next terminal session |
