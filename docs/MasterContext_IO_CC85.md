...
*Updated: 2026-08-14 (CC-85 — Sonnet counted. Branded magic link email via Resend SMTP. First full simulation run passed. OPS sign-out button styled. Redirect URLs cleaned. Commits 17ecb40, 306a587.)*
*Supersedes: MasterContext_IO_CC84*
...
| S-23 | Staff have no sign-out path from queue view — OPS only | Medium | Onboarding-A |
