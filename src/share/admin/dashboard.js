 ...
 * Migrated to refueler-io · AD-1 · 2026-08-09
 * Theme: rs-theme cookie · document.documentElement.dataset.theme only.
...
function toggleTheme(t) {
  ...
  document.cookie = `rs-theme=${t};path=/;domain=.refueler.io;max-age=2592000;SameSite=Lax`;
}
